                ...
                <div class="card-body">
                    <form method="POST" action="/user/{{$user->id}}/update">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="province" type="text" class="form-control{{ $errors->has('province') ? ' is-invalid' : '' }}" name="province" value="{{ $user->province }}" placeholder="eg. British Colombia" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="postal_code" type="text" class="form-control{{ $errors->has('postal_code') ? ' is-invalid' : '' }}" name="postal_code" value="{{ $user->postal_code }}" placeholder="eg. v6p4t9" required autofocus>
